...
interface SVGNFTInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "CreatedSVGNFT(uint256,string)": EventFragment;
    "Transfer(address,address,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "Approval"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "ApprovalForAll"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "CreatedSVGNFT"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Transfer"): EventFragment;
}

export class SVGNFT extends Contract {
  ...
  callStatic: {
    ...
    "create(string)"(svg: string, overrides?: CallOverrides): Promise<void>;
